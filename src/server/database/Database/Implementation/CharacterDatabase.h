...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_ACCOUNT_PERKS_CURRENCY,
    CHAR_UPD_ACCOUNT_PERKS_CURRENCY,
    CHAR_SEL_ACCOUNT_PERKS_HISTORY,
    CHAR_INS_ACCOUNT_PERKS_HISTORY,
    CHAR_SEL_ACCOUNT_PERKS_FROZEN,
    CHAR_INS_ACCOUNT_PERKS_FROZEN,
    CHAR_DEL_ACCOUNT_PERKS_FROZEN,
    CHAR_SEL_PERKS_VENDOR_ITEMS_CURRENT,

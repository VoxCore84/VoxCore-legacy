...
enum RBACPermissions
{
	...
	RBAC_PERM_COMMAND_CUSTOMNPC_CREATE                      = 2101,
    RBAC_PERM_COMMAND_CUSTOMNPC_SPAWN                       = 2102,
    RBAC_PERM_COMMAND_CUSTOMNPC_SET_DISPLAYNAME             = 2103,
    RBAC_PERM_COMMAND_CUSTOMNPC_SET_FACE                    = 2104,
    RBAC_PERM_COMMAND_CUSTOMNPC_SET_GENDER                  = 2105,
    RBAC_PERM_COMMAND_CUSTOMNPC_SET_RACE                    = 2106,
    RBAC_PERM_COMMAND_CUSTOMNPC_SET_SUBNAME                 = 2107,
    RBAC_PERM_COMMAND_CUSTOMNPC_EQUIP_ARMOR                 = 2108,
    RBAC_PERM_COMMAND_CUSTOMNPC_EQUIP_LEFT                  = 2109,
    RBAC_PERM_COMMAND_CUSTOMNPC_EQUIP_RANGED                = 2110,
    RBAC_PERM_COMMAND_CUSTOMNPC_EQUIP_RIGHT                 = 2111,
    RBAC_PERM_COMMAND_CUSTOMNPC_DELETE                      = 2112,
	RBAC_PERM_COMMAND_CUSTOMNPC_UNEQUIP_ARMOR               = 2113,
    RBAC_PERM_COMMAND_CUSTOMNPC_UNEQUIP_LEFT                = 2114,
    RBAC_PERM_COMMAND_CUSTOMNPC_UNEQUIP_RANGED              = 2115,
    RBAC_PERM_COMMAND_CUSTOMNPC_UNEQUIP_RIGHT               = 2116,
    ...
    RBAC_PERM_COMMAND_TYPING_ON                             = 1005,
    RBAC_PERM_COMMAND_TYPING_OFF                            = 1006,
    RBAC_PERM_COMMAND_TYPING                                = 1007,
    ...
    RBAC_PERM_COMMAND_CUSTOMNPC_SET_SCALE                   = 1363,
    RBAC_PERM_COMMAND_CUSTOMNPC_SET_TAMEABLE                = 1364,
    RBAC_PERM_COMMAND_CUSTOMNPC_REMOVE_VARIATION            = 1365,
    //// Aura system
    ...
    RBAC_PERM_COMMAND_WMORPH                                = 3000,
    RBAC_PERM_COMMAND_WSCALE                                = 3001,
    RBAC_PERM_COMMAND_REMORPH                               = 3002,

    RBAC_PERM_COMMAND_GOB_VISIBLE                           = 3004,

    RBAC_PERM_COMMAND_SCENARIO_ALL                          = 3005,

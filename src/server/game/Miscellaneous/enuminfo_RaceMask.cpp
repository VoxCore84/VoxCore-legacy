...
TC_API_EXPORT EnumText EnumUtils<Races>::ToString(Races value)
{
    switch (value)
    {
        ...
        case RACE_HARANIR_HORDE: return { "RACE_HARANIR_HORDE", "Haranir", "Haranir (Horde) (RaceMask bit 20)" };
        case RACE_HARANIR_ALLIANCE: return { "RACE_HARANIR_ALLIANCE", "Haranir", "Haranir (Alliance) (RaceMask bit 19)" };
...
TC_API_EXPORT Races EnumUtils<Races>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 29: return RACE_HARANIR_HORDE;
        case 30: return RACE_HARANIR_ALLIANCE;
...
TC_API_EXPORT size_t EnumUtils<Races>::ToIndex(Races value)
{
    switch (value)
    {
        ...
        case RACE_HARANIR_HORDE: return 29;
        case RACE_HARANIR_ALLIANCE: return 30;
        default: throw std::out_of_range("value");
    }
}
}

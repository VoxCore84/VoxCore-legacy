...
- For bash/grep: use `$(python3 -c "import sys; sys.path.insert(0,'C:/Users/atayl/VoxCore/wago'); from wago_common import WAGO_CSV_DIR; print(WAGO_CSV_DIR / 'SpellName-enUS.csv')")`
